...
-- TRIGGERS PARA REGISTRAR CAMBIOS EN CLIENTES

DELIMITER //
-- Trigger para registrar inserciones en la tabla Clientes
...
-- Trigger para registrar actualizaciones en la tabla Clientes
...
-- Trigger para registrar eliminaciones en la tabla Clientes
...
-- ROLES 
CREATE ROLE 'Gerencia', 'Administracion', 'Empleados';
